      ...
      chartHistory: {
        byTrain: {
          TRAIN_01: {
            ...
            resistanceTime: [] as [number, number][],
            davisResistanceTime: [] as [number, number][],
            gradientResistanceTime: [] as [number, number][],
            curveResistanceTime: [] as [number, number][],
            tunnelResistanceTime: [] as [number, number][],
            tractionEnergyTime: [] as [number, number][],
            regenEnergyTime: [] as [number, number][],
          },
        },
      },
    };
